...
router.put('/profile', auth_middleware_1.authenticate, multer_1.default.single('profileImage'), user_controller_1.updateUserProfile); // ইমেজ আপলোড মিডলওয়্যার যোগ
// Admin only routes
router.get('/admin/users', auth_middleware_1.authenticate, (0, auth_middleware_1.requireRole)(['admin']), (req, res) => {
